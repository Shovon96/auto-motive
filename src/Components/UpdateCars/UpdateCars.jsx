...
const UpdateCars = () => {
    ...
    const {_id, ImageURL, Name, price, rating, short_description, type,  } = lodedData
    ...
    return (
        <div>
            <div>
                <h2 className="text-4xl font-bold text-center">Update Your Car</h2>
            ...
            <form onSubmit={handleUpdateCar} className="border w-2/3 mx-auto my-12 p-5 bg-rose-100 rounded-md">
